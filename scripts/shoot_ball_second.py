...
import math
import smach_ros
from robot_state_class.shoot_ball_second_state import *


def shoot_second():
    shoot_ball_second = smach.StateMachine(outcomes=['successed', 'failed'])
    ...
    with shoot_ball_second:
        ...
        smach.StateMachine.add('SHOOT1',Shoot(),
                                transitions={'successed':'SHOVEL_UP2',
                                            'failed':'failed'})

        smach.StateMachine.add('SHOVEL_UP2',Shovel_UP(),
